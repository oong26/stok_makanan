...
class _EditMakananPageState extends State<EditMakananPage> {
  ...
  void _setData() {
    setState(() {
      _tfNamaController.text = widget.nama;
      _selectedKategori = widget.kategori;
      _tfStokController.text = widget.stok.toString();
      _tfDetailController.text = widget.detail;
      _tfShiftController.text = widget.shift.toString();
      _tfUploadController.text = widget.filename;
    });
  }
    ...
    return Scaffold(
      body: SafeArea(
        child: Padding(
          ...
          child: BlocConsumer<UpdateMakananCubit, UpdateMakananState>(
            listener: (context, state) {
              if (state is UpdateMakananSuccess) {
              ...
              if (state is UpdateMakananError) {
                ScaffoldMessenger.of(context).showSnackBar(SnackBar(
